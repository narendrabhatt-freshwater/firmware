...
samples/ms for one to three voices and 420 samples/ms for four to eight. Three
C6 voices from a matching C5 root need 288 samples/ms and fit. Continuous
RS485 `vq` is the sole refill authority and lifecycle monitor; USB vendor
traffic carries BODY PACKs OUT only.
