...
safe multi-voice limit is 420 samples/ms. Three C6 voices from a matching C5
root need 288 samples/ms and fit. USB vendor IN supplies one fresh `vq` status
