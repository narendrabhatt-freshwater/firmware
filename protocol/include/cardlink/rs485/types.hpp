 ...
 * tagged terminal lines; Channel `vq` uses a fixed 12-byte binary status
 * frame so its blocking UART response does not delay USB service.
 */
...
constexpr std::size_t kVqBinaryFrameLen = 12;
