...
constexpr unsigned kStreamUacBodySamples = kStreamUacChannels - 1u;
...
constexpr unsigned kStreamBodySamplesPerMs =
    kStreamUacBodySamples * kStreamUacFramesPerMs;
...
static_assert(kStreamBodySamplesPerMs == 459u,
              "nine BODY samples in each of 51 frames/ms");
