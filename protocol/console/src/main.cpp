 ...
 *        See docs/reference/rs485_console_architecture.md.
 */
...
using cardlink::rs485::ExchangeResult;
using cardlink::rs485::Link;
using cardlink::rs485::LinkOptions;
using cardlink::rs485::ParseTarget;
using cardlink::SerialPort;
using cardlink::rs485::Status;
using cardlink::rs485::Target;
using cardlink::rs485::TargetName;
