...
Load a 1 kHz sine sample through the production attack/BODY path, then compare
the same note with the filter bypassed and engaged.
...
n0
g 1 0
# start the loaded 1 kHz sample on n0 through the host sample transport
